...
public class Cat {
    ...
    public void setCute(boolean cute) {
        //(properties & CUTE) != 0 猫可爱
    if (cute && (properties & CUTE) == 0){
        properties |= CUTE;
    }else if (!cute && (properties & CUTE) != 0 ){
        properties &= (~CUTE);
    }
    ...
    public void setFat(boolean fat) {
        if (fat && (properties & FAT) == 0){
            properties |= FAT;
        }else if (!fat && (properties & FAT) != 0 ){
            properties &= (~FAT);
        }
    ...
    public void setWhite(boolean white) {
        if (white && (properties & WHITE) == 0){
            properties |= WHITE;
        }else if (!white && (properties & WHITE) != 0 ){
            properties &= (~WHITE);
        }
